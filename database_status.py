...
def Info_of_Database():
	console.print(f"Uptime, {r['Uptime']}", style='bold blue')
	console.print(f"Threads_created, {r['Threads_created']}", style='bold blue')
	console.print(f"Threads_connected, {r['Threads_connected']}", style='bold blue')
	console.print(f"Threads_running, {r['Threads_running']}", style='bold blue')
	console.print(f"Queries, {r['Queries']}", style='bold blue')
